class WcPanBox extends HTMLElement {
	#zoom = 1.0;
	#lastPointer;
	#lastScroll;
	#modifierKey;
  #minZoom = 0.1;
	...
	render() {
		...
		this.shadowRoot.innerHTML = `
            <style nonce="XYZ123">
				#viewport { height: 100%; width: 100%; overflow: auto; cursor: grab; display: flex; justify-content: center; transition: all 2 ease;}
				#viewport.manipulating { cursor: grab; }
            </style>
